...
/*   Updated: 2017/09/13 19:20:26 by jblancha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							ft_push_line(t_field **field, char **line,
											int height);
t_field						**ft_read_file(char *filename);
int							ft_push_point(int x, int y,
										char *str, t_field **field);
...
void						ft_plotline (t_env *env, t_point point_ori,
										t_point point_des);
...
int							ft_linesplit(t_field **field, int height,
														char **line);
void						ft_penteinf(t_env *env, t_point point_ori,
												t_point point_des);
void						ft_pentesup(t_env *env, t_point point_ori,
												t_point point_des);
void						ft_lightpixel(t_point point, t_env *env, int color);
void						ft_init_point(t_field **field, t_point *point,
												int i, int j);
void						ft_get_line_param(t_line_param *param_line,
								t_point point_ori, t_point point_des);
